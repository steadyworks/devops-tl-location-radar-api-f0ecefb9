...
class RemotePhotobookGenerationJobProcessor(
    ...
    async def process(
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            downloaded_paths_and_exifs: dict[
                UUID, tuple[Path, Optional[dict[str, Any]]]
            ] = dict()
            ...
            for asset_uuid, asset_key in asset_uuid_asset_key_map.items():
                ...
                if isinstance(download_result, Exception):
                    ...
                    downloaded_paths_and_exifs[asset_uuid] = (
            ...
            if not downloaded_paths_and_exifs:
            ...
            try:
                ...
                async def run_job_with_retry(
                    paths_and_exifs: list[tuple[Path, Optional[dict[str, Any]]]],
                ...
                (
                    ...
                    coro_factory=lambda: run_job_with_retry(
                        list(downloaded_paths_and_exifs.values()),
